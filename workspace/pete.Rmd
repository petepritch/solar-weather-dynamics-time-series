...
par(mfrow=c(1,2))
acf(coredata(sun.data), lag.max = 150, main = "ACF of Monthly Sunspots short period")
pacf(coredata(sun.data), lag.max = 150, main = "PACF of Monthly Sunspots short period")
```
