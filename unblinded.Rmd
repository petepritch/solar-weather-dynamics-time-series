...
```{r echo=FALSE, fig.cap="Inital plots", warning=FALSE, message=FALSE}
p1 <- df %>%
    ggplot(aes(date, y)) +
...
Later in the report, we'll use the ACF and PACF shown in Figure () to estimate the appropriate model parameters to fit to our series.
